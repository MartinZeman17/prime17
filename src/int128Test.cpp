...
using namespace primecount;
  ...
  void check128(bool Res) {
    std::cout << "   " << (Res ? "OK" : "ERROR") << "\n";
    if (!Res)
      exit(1);
  }
#endif
...
int int128Test()
{
...

  {
    ...
    s << (((int128_t) 1 ) << 100);
    cout << "2^100 = " << s.str();
    check128(s.str() == "1267650600228229401496703205376");
  }

  {
    ...
    cout << "-2^127+1 = " << s.str();
    check128(s.str() == "-170141183460469231731687303715884105727");
  }
...

  {
    ...
    cout << "2^128-1 = " << s.str();
    check128(s.str() == "340282366920938463463374607431768211455");
  }
